...
For development purposes, you might need a way to boot from the primary firmware regardless of the boot counter. To do this you can load the reset_boot.elf program, which resets the counter and branches to the primary firmware.
